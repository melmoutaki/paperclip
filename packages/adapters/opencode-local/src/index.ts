...
- dangerouslySkipPermissions (boolean, optional, default false): inject a runtime OpenCode config that allows \`external_directory\` access without interactive prompts only when explicitly enabled
